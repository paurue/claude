...
def _conditional_mutual_information_formula(entropy_xz, entropy_yz,
                                            entropy_xyz, entropy_z):
    return entropy_xz + entropy_yz - entropy_xyz - entropy_z


def _interaction_information_formula(conditional_mutual_information,
                                     mutual_information):
...
def _redundancy(probabilities_target,
    ...
    for (i, probability_target) in enumerate(probabilities_target):
        specific_information_source_1 = \
            _specific_information_formula(probabilities_source_1_target[:, i],
                                          probabilities_source_1,
                                          probability_target)
        specific_information_source_2 = \
            _specific_information_formula(probabilities_source_2_target[:, i],
                                          probabilities_source_2,
                                          probability_target)
